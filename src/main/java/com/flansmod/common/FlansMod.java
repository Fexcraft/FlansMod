...
public class FlansMod {
	...
	public void init(FMLInitializationEvent event){
		...
		//Register driveables
		EntityRegistry.registerModEntity(EntityPlane.class, "Plane", 90, INSTANCE, 256, 3, false);
		EntityRegistry.registerModEntity(EntityVehicle.class, "Vehicle", 95, INSTANCE, 256, 10, false);
		EntityRegistry.registerModEntity(EntitySeat.class, "Seat", 99, INSTANCE, 256, 10, false);
		EntityRegistry.registerModEntity(EntityWheel.class, "Wheel", 103, INSTANCE, 256, 20, false);
