...
public class SlotGun extends Slot 
{
	...
	public boolean isItemValid(ItemStack stack)
	{
		switch(slotID)
		{
		case 0 : return stack == null || (stack.getItem() instanceof ItemGun && !((ItemGun)stack.getItem()).getInfoType().deployable) && stack.getTagCompound() != null;
	...
	public boolean canAttachToCurrentGun(ItemStack stack)
	{
		...
		GunType gunType = ((ItemGun)gunSlot.getStack().getItem()).getInfoType();
