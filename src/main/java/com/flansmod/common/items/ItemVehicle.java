...
public class ItemVehicle extends ItemMapBase implements IItem {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer entityplayer, EnumHand hand){
        ...
        if(movingobjectposition.typeOfHit == RayTraceResult.Type.BLOCK){
            ...
            if(type.placeableOnLand || block instanceof BlockLiquid){
	            if(!world.isRemote){
					world.spawnEntityInWorld(new EntityVehicle(world, (double)pos.getX() + 0.5F, (double)pos.getY() + 2.5F, (double)pos.getZ() + 0.5F, entityplayer, type, getData(entityplayer.getHeldItemMainhand(), world)));
	            }
